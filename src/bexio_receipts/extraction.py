    ...
    async with httpx.AsyncClient(timeout=60.0) as http_client:
        ...
        agent = Agent(  # type: ignore[call-overload]
            ...
            system_prompt=(
                ...
                "4. TABULAR DATA: The OCR text may contain tables (Markdown or space-separated). "
                "In the VAT summary table, columns are typically: VAT amount | Base (exkl.) | Total (inkl.). "
                "WARNING: The numbers often shift left under the wrong headers! The FIRST number after the rate is usually the VAT AMOUNT, followed by Base (Exkl), then Total (Inkl).\n"
