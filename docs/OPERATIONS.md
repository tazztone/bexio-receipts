...
This guide covers initial production setup and ongoing maintenance tasks for `bexio-receipts`.

## 🚀 Initial Production Setup

Follow these steps when switching from the local Mock Bexio environment to your real Bexio account.
